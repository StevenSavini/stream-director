...
ActiveRecord::Schema.define(version: 20170508145630) do
  ...
  create_table "group_movies", force: :cascade do |t|
    t.integer "group_id"
    t.integer "user_id"
    t.index ["group_id"], name: "index_group_movies_on_group_id", using: :btree
    t.index ["user_id"], name: "index_group_movies_on_user_id", using: :btree
  end
